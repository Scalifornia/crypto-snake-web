...
- Features in progress:
  - Kliko marketplace flow after the approved homepage: category-first search, cleaner listing result cards, sortable listing results, stronger listing detail pages, visible quote context in the request review step, provider listing creation with a public preview, and frontend-only request attachments.
